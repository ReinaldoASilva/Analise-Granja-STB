...
def main():
    ...
    # Adicionando seleção de páginas na barra lateral
    pagina_selecionada = st.sidebar.selectbox("Navegar", ["Página Inicial", "Temperatura", "Outra Página"])
    ...
    elif pagina_selecionada == "Outra Página":
